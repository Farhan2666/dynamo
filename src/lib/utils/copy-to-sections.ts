      ...
      case "pricing":
        return {
          ...
          content: {
            ...
            plan_1_cta: cta || nicheContent.cta,
            ...
            plan_2_cta: cta || nicheContent.cta,
      ...
      case "stats":
        return {
          ...
          content: {
            ...
            stat_1_value: statValues[0],
            stat_1_label: statLabels[0],
            stat_2_value: statValues[1],
            stat_2_label: statLabels[1],
            stat_3_value: statValues[2],
            stat_3_label: statLabels[2],
            stat_4_value: statValues[3],
            stat_4_label: statLabels[3],
          },
        };
      ...
      case "gallery":
        return {
          ...
          content: {
            ...
            category_5: gTemplates.categories[4],
            category_6: gTemplates.categories[5],
      ...
      case "comparison":
        return {
          ...
          content: {
            ...
            row_7: compTemplates.rows[6],
            row_8: compTemplates.rows[7],
            ...
            our_val_7: compTemplates.our_vals[6],
            our_val_8: compTemplates.our_vals[7],
            ...
            their_val_7: compTemplates.their_vals[6],
            their_val_8: compTemplates.their_vals[7],
          },
        };
