                ...
                <div key={i} className="p-6 rounded-medium bg-white border border-gray-100">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-caption text-text-muted">{content[`role_${i}`] || "Verified"}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <div key={i} className="p-6 rounded-medium bg-white border border-gray-100 shadow-soft text-center">
